...
<i>Web page done using the IMDB API, it includes functionalities like pagination, a searchbar, you can see, delete or have access to the details of a specific movie.<i/>
